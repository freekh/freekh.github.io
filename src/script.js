 ...
 * I wrote this in 2017 and as we know, a lot's changed since then.
 * Still, the last time this CV was updated (2025) I did not feel like replacing it :)
 *
...
function initBouncingSkyline() {
  ...
  if (!gl) {
    console.error(
      "This browser does not have a context I can draw cool stuff in. No worries tho"
    );
    return;
  }
...
function createShader(gl, type, text) {
  ...
  console.error(
    "Could not create/compile " + type + " shader:",
